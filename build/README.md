...
![mdviewer Split Screen Preview](screenshot.png)
...
- `bin/` - Output directory containingcompiled production binaries.
- `darwin/` - macOS specific package configuration and plist resources.
- `windows/` - Windows installer scripts, manifests, and app icons.
- `appicon.png` - The source 1024x1024 neon glassmorphic app icon.
- `screenshot.png` - Preview screenshot of the application workspace.
